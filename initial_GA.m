...
%% ==================== 5. 主循环 ====================
fprintf('========== 原始遗传算法（无精英保留，种群规模=100）开始优化 ==========\n');
...
for gen = 1:max_gen
    ...
    %% 5.4 【原始算法】无精英保留，直接进行选择、交叉、变异
    
    % 锦标赛选择（生成与种群规模相同的父代池）
    parent_pool = zeros(pop_size, 2);
    for i = 1:pop_size
